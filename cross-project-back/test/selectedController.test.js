...
const ctrl = require('../controllers/selectedControllers');
...
describe('Controller tests', () => {
  ...
  describe('Selected page is working', () => {
    beforeEach(() => {
  ...
  describe('Selected is not working', () => {
    beforeEach(() => {
      req.params = { id: '' };  
    });
  ...
  describe('Selected page returns empty array', () => {
    beforeEach(() => {
